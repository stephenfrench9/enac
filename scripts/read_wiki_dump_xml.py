...
# C:\Users\Stephen\Documents\supportProj
PATH_WIKI_XML = 'E:\\'
...
# pathWikiXML = 'C:\\Users\\Stephen\\Documents\\enac wrapper\\enwiki-latest-pages-articles.xml.bz2'
    ...
    for event, elem in etree.iterparse(pathWikiXML, events=('start', 'end')):
        ...
        if event == 'start':
            ...
            if tname == 'title':
                ...
                print(str(type(elem.text)))
                print(str(len(elem.text)))
                print(elem.text)
                print("end")
                time.sleep(3)
